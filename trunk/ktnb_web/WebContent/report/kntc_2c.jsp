...
<h3 class="Header">Tổng hợp kết quả giải quyết đơn KN - Mẫu số 2C/KNTC</h3>
<html:form action="/kntc_rp.do?method=bc2c" >
<html:hidden property="arrCqt"/>
<html:hidden property="loaiBc" value="bc2c"/>
<html:hidden property="tenBc" value="2c"/>
