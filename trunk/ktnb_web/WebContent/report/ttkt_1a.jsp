...
<h3 class="Header">BÁO CÁO KẾT QUẢ CÔNG TÁC KIỂM TRA NỘI BỘ NGÀNH - Mẫu số 1A/KTNB</h3>
<html:form action="/kntc_rp.do?method=bc1a" >
<html:hidden property="arrCqt"/>
<html:hidden property="loaiBc" value="ttkt1a"/>
<html:hidden property="tenBc" value="1a"/>
