...
<h3 class="Header">Báo cáo Thanh tra Kiểm tra hệ thống KTNB-43F</h3>
<html:form action="/kntc_rp.do?method=bcTtKt" >
<html:hidden property="arrCqt"/>
<html:hidden property="loaiBc" value="bcTtKt"/>
<html:hidden property="tenBc" value="43f"/>
<fieldset>
