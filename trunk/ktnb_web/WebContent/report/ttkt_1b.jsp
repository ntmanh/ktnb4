...
<h3 class="Header">BÁO CÁO CÔNG TÁC QUẢN LÝ NHÀ NƯỚC VỀ KIỂM TRA NỘI BỘ - Mẫu số 1A/KTNB</h3>
<html:form action="/kntc_rp.do?method=bc1b" >
<html:hidden property="arrCqt"/>
<html:hidden property="loaiBc" value="ttkt1b"/>
<html:hidden property="tenBc" value="1b"/>
