...
<!-- Báo cáo kết quả xác minh mẫu 17/KNTC . Tương tự  mẫu 23/KNTC -->
...
$(document).ready(function() {
    var ghiTC_17 = "";
	 <logic:present name="ghiThanhcong_17">
	     	ghiTC_17 = '<%=request.getAttribute("ghiThanhcong_17")%>';
	 </logic:present>
	 if(ghiTC_17=='1'){
	 ...
	 <%request.removeAttribute("ghiThanhcong_17");%>	
});
function warningKt(){
...
function openUploadFile_17(){
    ...
    if(maHS!=null && maHS!='' && maHS!='null')
		openWindow("UploadAction.do?parentId="+maHS+"&nv=KNTC/BCKQXM17&view="+view);
	else
		alert("Chưa có thông tin về hồ sơ!");	
}
function downloadFile_17(){
	document.forms[2].action="kntc_bc_kq_xm.do?method=downloadKNTC17";
	document.forms[2].submit();
