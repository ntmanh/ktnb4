...
<html:form action="/phieu_dxxl_kn.do?method=show" method="post" styleId="form">
	...
	<TABLE width="100%">
		<tr>
			...
			<td colspan="3" width="85%"><html:select property="thamQuyen" style="width:100%;" onchange="changeThamQuyen(this.value);">
	...
	<div id="divQuaHan">	
		<table width="100%">
		<tr>
			<td align="right" width="15%"><font style="font-size: 12px; color: red">Hồ
			sơ quá hạn</font></td>
			<td colspan="3" width="85%"><html:radio property="quaHan" value="1">Có</html:radio>
	...
	<TABLE width="100%">
		<tr>
			<td width="15%" style="text-align: right;">Đơn gửi lần <font style="color: red">*</font></td>
	...
	<TABLE width="100%">
		...
		<tr>
			...
			<td colspan="3"><html:textarea property="ndDaQG" style="width:100%;height:40px" /></td>
		</tr>
	</TABLE>
	</fieldset>
	</div>
	...
	<TABLE width="100%">
		<tr>
			...
			<td colspan="3">
			<html:textarea property="deXuatXL" style="width:100%;height: 60px" /></td>
		</tr>
		<tr>
...
<script language="javascript">
	...
	$(function(){
		...
		if(document.forms[0].luuDon.value=='true'){
			document.forms[0].thamQuyen.value = "15020203";
			document.forms[0].thuLy.value = "1502020305";
			hide("divThamQuyen");
		...
		if(document.forms[0].thamQuyen.value == "15020201"){
			$("#super-tabs").tabs("option", "disabled", [1,2]);
		}
	...
	function ghi(){		
		...
		if(!isEmpty(document.forms[0].ngayDuyet.value)){			
			...
			else if(!compareDate(document.forms[0].ngayDx,document.forms[0].ngayDuyet,'Ngày duyệt đề xuất phải sau ngày lập đề xuất')){
				return false;
			}	
