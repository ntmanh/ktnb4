...
<h3 class="Header">Quyết định gia hạn thời gian xác minh - 16/TC</h3>
...
function print(){
   document.forms[0].action="kntc_xm_gia_han.do?method=inGhXm&type=TC16&action="+'<%=request.getParameter("action")%>';
		document.forms[0].submit();
}
