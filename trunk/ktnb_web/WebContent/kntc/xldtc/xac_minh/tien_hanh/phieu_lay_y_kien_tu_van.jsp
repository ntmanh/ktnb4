...
$(function(){
    ...
    var url='kntc_xm_phieu_yc.do?method=getListPhieu&maHs='+document.forms[0].kntcQdinhXm.value+'&t=15A/KNTC';
...
function ghi(){
	document.forms[0].action="kntc_xm_phieu_yc.do?method=saveYktv";
