...
<!-- Phiếu chuyển đơn tố cáo mẫu 20 -->
...
<html:form action="/kntc_dxxl.do?method=phieuCd">
	...
	<table width="100%">
		...
		<tr>
			<td style="text-align: right">Người, cơ quan, đơn vị Tố cáo</td>
			<td><html:text property="nguoiCqDvKn" style="width: 100%" readonly="true" /></td>
			<td style="text-align: right">Địa chỉ người, cơ quan, đơn vị Tố cáo</td>
...
function print(){		
		document.forms[0].action="kntc_dxxl.do?method=in&type=TC03";
		document.forms[0].submit();
}
</script>
