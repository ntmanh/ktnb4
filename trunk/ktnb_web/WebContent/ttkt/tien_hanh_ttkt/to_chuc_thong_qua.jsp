...
<h3 class="Header">T&#7893; ch&#7913;c th&#244;ng qua v&#7899;i &#273;&#417;n v&#7883; &#273;&#432;&#7907;c Thanh tra Ki&#7875;m tra</h3>
<fieldSet><html:form action="to_chuc_thong_qua.do">
	...
	<TABLE width="100%" align="center">
		<TBODY>
			<tr>
				...
				<td width="1%"></td>
				<!--  <td width="30%"><html:text styleClass="text" property="thoiGian" onblur="isDate(this)"
			...
			<tr>
				...
				<td width="1%"></td>
				<td colspan="4"><html:textarea property="noiDungLamViec" onkeypress="imposeMaxLength(this);"  style="width: 100%;height: 70px" /></td>
			</tr>
			<tr>
				<td align="right" width="19%">Di&#7877;n bi&#7871;n, k&#7871;t qu&#7843; <font color=red>*</font></td>
				<td width="1%"></td>
				<td colspan="4"><html:textarea property="ketQua" onkeypress="imposeMaxLength(this);"  style="width: 100%;height: 70px" /></td>
			</tr>
			<tr>
