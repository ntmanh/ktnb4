...
<html:form action="/kntc_tim_kiem_chuyen_ho_so.do?method=show">
<div id="super-tabs">
<ul>
...
var act = '<%=request.getParameter("action")%>';
  ...
  var url=encodeURI('kntc_tim_kiem_chuyen_ho_so.do?method=search&maHs=%'+$('#data').val()+'%&nnd='+$('#nguoiNopDon').val()+'&cbxl='+$('#canBoXL').val()+'&nuq='+$('#nguoiUyQuyen').val()+'&tSearch='+$('#textSearch').val()+'&tt='+$('#tt').val()+'&loai='+$('#loai').val()+'&sDate='+$('#sDate').val()+'&fDate='+$('#fDate').val()+'&cvsDate='+$('#cvsDate').val()+'&cvfDate='+$('#cvfDate').val()+'&action='+act);
...
function filter(){
	...
	var act = '<%=request.getParameter("action")%>';
    var url=encodeURI('kntc_tim_kiem_chuyen_ho_so.do?method=search&maHs=%'+$('#ma').val()+'%&nnd='+$('#nguoiNopDon').val()+'&cbxl='+$('#canBoXL').val()+'&nuq='+$('#nguoiUyQuyen').val()+'&tSearch='+$('#textSearch').val()+'&tt='+$('#tt').val()+'&loai='+$('#loai').val()+'&sDate='+$('#sDate').val()+'&fDate='+$('#fDate').val()+'&cvsDate='+$('#cvsDate').val()+'&cvfDate='+$('#cvfDate').val()+'&cqt='+s+'&action='+act);
	//alert(url);
...
function del(){
	if (confirm("Bạn có chắc chắn muốn xóa?")){
		...
		window.location = "kntc_tim_kiem_chuyen_ho_so.do?method=del&id="+ma;
	}
}
...
function search(){	
	document.forms[0].action='kntc_tim_kiem_chuyen_ho_so.do?method=show';
