...
<fieldset><legend>Biễu mẫu phụ</legend>
	<table width="100%">
		<tr>
			<td width="50%"><a href="#" onclick="openBm2('kntc_khxm.do?method=bb&action=bbxmkn&id=');">Biên bản công bố quyết định xác minh Khiếu Nại - Mẫu 08/KN</a></td>
			<td><a href="#" onclick="openBm2('kntc_xm_phieu_yc.do?method=ycgt&action=phieuYcGtKN&id=');">Phiếu yêu cầu giải trình - Mẫu 11A/KN</a></td>
		</tr>
		<tr>
			<td><a href="#" onclick="openBm2('kntc_khxm.do?method=bb&action=bbLamViecNguoiKN&id=');">Biên bản làm việc với người Khiếu Nại - Mẫu 08/KN</a></td>
			<td><a href="#" onclick="openBm2('kntc_xm_phieu_yc.do?method=yktv&action=yktvKN&id=');">Lập phiếu lấy ý kiến tư vấn - Mẫu 12/KN</a></td>
		</tr>
		<tr>
			<td><a href="#" onclick="openBm2('kntc_khxm.do?method=bb&action=bbLamViecNguoiBiKN&id=');">Biên bản làm việc với người bị Khiếu Nại - Mẫu 08/KN</a></td>
		...
		<tr>
			<td><a href="#" onclick="openBm2('kntc_xm_bb_doi_thoai.do?method=show&action=view&id=');">Biên bản đối thoại - Mẫu 17/KN</a></td>
<!--			<td><a href="#" onclick="openBm2('kntc_qd_dinh_chi_kn.do?method=show&action=view&type=Qddckn&id=');">Quyết định đình chỉ khiếu nại - Mẫu 18/KN</td>-->
			<td><a href="#" onclick="openBm2('kntc_bo_sung_hs.do?method=showTlkt&action=bshs&maHs=');">Giấy biên nhận - Mẫu 10/KN</a></td>
		</tr>
		
		<tr>
			<td><a href="#" onclick="openBm2('kntc_qd_tam_dinh_chi_thi_hanh.do?method=show&action=view&type=tam&id=');">Quyết định tạm đình chỉ thi hành quyết định hành chính bị khiếu nại - Mẫu 19/KN</a></td>
