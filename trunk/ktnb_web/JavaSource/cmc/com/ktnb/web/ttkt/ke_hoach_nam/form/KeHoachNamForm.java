 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class KeHoachNamForm extends NoiDungTtktForm {
	 ...
	 * @return
	 */
	public String getLoaiCuocTtktSuaKH() {
		return loaiCuocTtktSuaKH;
	}

	/**
	 * @param string
	 */
	public void setLoaiCuocTtktSuaKH(String string) {
		loaiCuocTtktSuaKH = string;
	}
