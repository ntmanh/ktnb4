	...
	<table align="center" width="100%">
		<logic:notPresent name="readOnly">
			<tr>
				...
				<td align="left" width="49%"><A href="#" onclick="downLoadBieuMau35()"> <font color=blue>M&#7851;u s&#7889; 35/TTNB</font> </A></td>
...
function downLoadBieuMau35(){
	...
	printfForm.action = 'ket_thuc_ttkt.do?method=in&type=downloadMau35&idCuocTtkt=' + document.getElementsByName('idCuocTtkt')[0].value;
	printfForm.submit();
