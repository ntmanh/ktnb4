...
<fieldset><legend>Biễu mẫu phụ</legend>
	<table width="100%">
		<tr>
			...
			<td><a href="#" onclick="openBm2('kntc_xm_phieu_yc.do?method=ycgt&action=phieuYcGtTC&id=');">Phiếu yêu cầu giải trình - Mẫu 14A/KNTC</a></td>
		</tr>
		<tr>
			...
			<td><a href="#" onclick="openBm2('kntc_xm_phieu_yc.do?method=yktv&action=yktvTC&id=');">Lập phiếu lấy ý kiến tư vấn - Mẫu 15A/KNTC</a></td>
		</tr>
		<tr>
			...
			<td><a href="#" onclick="openBm2('kntc_xm_phieu_yc.do?method=tcgd&action=ycgdTC&id=');">Lập phiếu yêu cầu, trưng cầu giám định - Mẫu 15B/KNTC</a></td>
		</tr>
		<tr>
			...
			<td><a href="#" onclick="openBm2('kntc_xm_gia_han.do?method=giahan&action=giahanTC&id=');">Quyết định gia hạn thời gian xác minh - Mẫu 16/KNTC</a></td>
		</tr>
		<tr>
