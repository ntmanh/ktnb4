...
<h3 class="Header">Tổng hợp kết quả công tác tiếp dân - Mẫu số 2A/KNTC</h3>
<html:form action="/kntc_rp.do?method=bc2a" >
<html:hidden property="arrCqt"/>
<html:hidden property="loaiBc" value="bc2a"/>
<html:hidden property="tenBc" value="2a"/>
