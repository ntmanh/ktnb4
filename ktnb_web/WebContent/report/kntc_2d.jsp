...
<h3 class="Header">Tổng hợp kết quả giải quyết đơn TC - Mẫu số 2D/KNTC</h3>
<html:form action="/kntc_rp.do?method=bc2d" >
<html:hidden property="arrCqt"/>
<html:hidden property="loaiBc" value="bc2d"/>
<html:hidden property="tenBc" value="2d"/>
