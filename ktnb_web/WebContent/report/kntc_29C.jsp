...
<h3 class="Header">Báo cáo tổng hợp đơn Khiếu nại theo nội dung - Mẫu số 29C/BC/KNTC </h3>
<html:form action="/kntc_rp.do?method=bcKnNd" >
<html:hidden property="arrCqt"/>
<html:hidden property="arrNd"/>
<html:hidden property="loaiBc" value="bcKnNd"/>
<html:hidden property="tenBc" value="29C"/>
<fieldset>
	...
	<table width="100%">
		...
		<td width="60%">
			...
			<table width="100%">
				...
				<tr>
					...
					<td width="20%"><html:text property="nam" maxlength="4" style="width: 65px;font-size: 12px;" onkeypress="return formatInt(event)" onblur="isNumberInt(this);"/></td>
					<td width="20%">Loại kỳ</td>
					<td width="10%">
						<html:select property="tuNgay" style="width: 65px;font-size: 12px;">
							<html:option value="THANG">Tháng</html:option>
							<html:option value="QUY">Quý</html:option>
							<html:option value="NAM">Năm</html:option>
						</html:select>
					</td>
					<td width="20%">Chi tiết kỳ</td>
					<td width="10%"><html:text property="kyBc" maxlength="2" style="width: 75px;font-size: 12px;"  onkeypress="return formatInt(event)" onblur="isNumberInt(this);"/></td>
				</tr>
				 -->
				<tr>
					<td>Nơi lập</td>
		...
		<% if(KtnbUtil.isTongCuc(ac)) { %>
			...
			<% if(KtnbUtil.isTongCuc(ac)) { %>		
				<div style="width:auto;height:215px;display:block;overflow:auto;border:1px solid #f1f1f1;padding:1px">
			<%} else %>
				<div style="width:auto;height:235px;display:block;overflow:auto;border:1px solid #f1f1f1;padding:1px">
			<!--CO QUAN THUE--> 
