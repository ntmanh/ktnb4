...
<h3 class="Header">Báo cáo tổng hợp đơn Tố cáo Hệ thống KTNB</h3>
<html:form action="/kntc_rp.do?method=bcTc" >
<html:hidden property="arrCqt"/>
<html:hidden property="loaiBc" value="bcTc"/>
<fieldset>
		...
		<td width="55%">
			...
			<table width="100%">
				<tr>
					<td>Loại báo cáo</td>
					<td colspan="5">
						<html:select property="tenBc" styleId="loai" style="width: 100%">
				...
				<tr>
					...
					<td colspan="2"><html:text property="tuThang" style="width: 65px;font-size: 12px;" alt="mm/yyyy" onkeypress="return formatDateMonth(event, this)" onblur="isMonth(this)"/>
					</td>
					<td>Đến tháng<font color="red">*</font></td>
					<td colspan="2"><html:text property="denThang" style="width: 75px;font-size: 12px;" alt="mm/yyyy" onkeypress="return formatDateMonth(event, this)" onblur="isMonth(this)"/></td>
				</tr>
				<!-- <tr>
