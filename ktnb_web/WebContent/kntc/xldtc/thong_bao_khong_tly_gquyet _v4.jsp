...
<html:form action="kntc_dxxltc.do" method="POST"
	...
	<table width="100%">
		...
		<tr>
			<td width="24%" align="right">Địa điểm ban hành<font color="red">*</font></td>
			<td style="width: 1%; min-width: 5px"></td>
			<td width="25%">
		...
		<tr>
			<td width="24%" align="right">Lý do không giải quyết<font color="red">*</font></td>
			<td style="width: 1%; min-width: 5px"></td>
