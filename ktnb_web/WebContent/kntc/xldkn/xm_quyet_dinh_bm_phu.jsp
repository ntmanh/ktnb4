...
<html:form action="/kntc_xac_minh.do?method=showQdXmMauPhu">
	...
	<h3 class="Header">Quyết định thụ lý giải quyết tố cáo và thành lập Đoàn/Tổ xác minh - Mẫu 07/TC</h3>
...
function openUploadFile(){
    ...
    if(maHS!=null && maHS!='' && maHS!='null')
		openWindow("UploadAction.do?parentId="+maHS+"&nv=KNTC/LDXM&view="+view);
	else
...
function ghi(){
	...
	//alert(arrCB);
		...
		document.forms[0].action='kntc_xac_minh.do?method=save&type=dxm&id=' + maHS;
