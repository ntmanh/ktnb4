...
<html:form action="/kntc_tiep_dan.do?method=show" method="post" styleId="form">
<div id="super-tabs"> 
<ul>
	...
	<div id="super-tab0">
		...
		<ul>
			...
			<li id="liXuLy" style="visibility: hidden;"><a href="#tab3"><span>Thông tin xử lý</span></a></li>
		</ul>
