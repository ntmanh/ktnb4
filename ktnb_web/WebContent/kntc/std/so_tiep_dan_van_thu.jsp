...
function validTTChungTab(){
	...
	if(!compareDate(document.forms[0].ngayNhanCongVanVT,document.forms[0].ngayNhanCongVan,'Ngày bộ phận xử lý nhận đơn phải sau bộ phận văn thư nhận đơn')) return false;
	return true;	
}
function openDsHoSo(){
