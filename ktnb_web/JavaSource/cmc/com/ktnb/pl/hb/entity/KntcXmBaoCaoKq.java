...
/**
 * KntcXmBaoCaoKq entity. @author MyEclipse Persistence Tools
 */

public class KntcXmBaoCaoKq extends cmc.com.ktnb.pl.hb.entity.PersistentObject implements java.io.Serializable {
	...
	private String maHs;
	private Long ketThucXm;

	// Constructors

	/** default constructor */
	public KntcXmBaoCaoKq() {
	}

	/** minimal constructor */
	public KntcXmBaoCaoKq(String ma, String maHs) {
		this.ma = ma;
		this.maHs = maHs;
	}
	...
	public Long getKetThucXm() {
		return ketThucXm;
	}

	public void setKetThucXm(Long ketThucXm) {
		this.ketThucXm = ketThucXm;
	}
